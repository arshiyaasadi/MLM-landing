...
![Figure 2. Between-group Hedges' g at final follow-up (T3): Supraorbital vs. Sham and Infraorbital vs. Sham, based on Δ = Baseline − 3 Months (Table 10 data). Squares/circles denote point estimates; horizontal lines denote 95% confidence intervals.](forest_plot_t3.png)
