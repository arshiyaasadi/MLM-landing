...
const plans = [
  {
    key: 'starter',
    featured: false,
    price: { Monthly: '$۰', Annually: '$۰' },
    logomarkClassName: 'fill-gray-300',
  },
  {
    key: 'investor',
    featured: false,
    price: { Monthly: '$۷', Annually: '$۷۰' },
    logomarkClassName: 'fill-gray-500',
  },
  {
    key: 'vip',
    featured: true,
    price: { Monthly: '$۱۹۹', Annually: '$۱,۹۹۰' },
...
function Plan({
  ...
  const planData = t(`pricing.plans.${planKey}`)
  
  // Get features based on plan key
  const getFeatures = (): string[] => {
    const features: any = t(`pricing.plans.${planKey}.features`)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="ml-4">{t(`pricing.plans.${planKey}.name`)}</span>
      </h3>
      <p
        className={clsx(
      ...
      <Button
        ...
        className="mt-6"
        aria-label={`Get started with the ${t(`pricing.plans.${planKey}.name`)} plan for ${price}`}
      >
        {t(`pricing.plans.${planKey}.buttonLabel`)}
      </Button>
    </section>
  )
}
      ...
      <Container>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-10 sm:mt-20 lg:max-w-none lg:grid-cols-3">
          {plans.map((plan) => {
            ...
            return <Plan key={key} {...planProps} activePeriod={activePeriod} planKey={key} />
          })}
        </div>
      </Container>
    </section>
