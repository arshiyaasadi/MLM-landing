...
interface PhoneFrameParallaxProps {
  mouseX: number
  mouseY: number
  children: React.ReactNode
}

function PhoneFrameParallax({ mouseX, mouseY, children }: PhoneFrameParallaxProps) {
  // Use spring animation for smooth transitions
  const springX = useSpring(mouseX * 40, { stiffness: 150, damping: 20 })
  const springY = useSpring(mouseY * 40, { stiffness: 150, damping: 20 })
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              ...
              >
                ...
                <span className="ml-2.5">{t('hero.watchVideo')}</span>
              </Button>
            </div>
          </div>
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
            ...
            <PhoneFrameParallax mouseX={mousePosition.x} mouseY={mousePosition.y}>
