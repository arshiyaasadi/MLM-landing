          ...
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className="mt-6 font-semibold text-gray-900">
                {t(`secondaryFeatures.features.${feature.name}.name`)}
              </h3>
              <p className="mt-2 text-gray-700">{t(`secondaryFeatures.features.${feature.name}.description`)}</p>
            </li>
          ))}
        </ul>
      </Container>
